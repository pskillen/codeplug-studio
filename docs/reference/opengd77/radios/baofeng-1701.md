...
| APRS | Yes (firmware) | **Partial** | `Channels.APRS` name bidirectional mappings; `APRS.csv` body not modelled |
...
Profile selection is implemented at import and export via `src/core/import-export/formats/opengd77/profiles.ts`:
