...
The app exports one channel row per repeater/site with a TG list reference — the lean model. Formats without native RGL support use shared [multi-talkgroup expansion](../../reference/multi-talkgroup-expansion.md) instead (archive reference #36).
