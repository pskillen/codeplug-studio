...
- **Indices:** zero-based position in the **canonical 38-file CPS order** (see table below). Partial exports **keep canonical indices** — they do not renumber from 0..count−1. Example: DMR-only Studio export uses indices `0,2,3,5,8,15` (`RadioIDList.CSV` at index `1` omitted until modelled — [#302](https://github.com/pskillen/codeplug-studio/issues/302)).
...
| ----- | ----------------------------------------------------------------------------------------------------- |
| 0     | `Channel.CSV`                                                                                         |
| 1     | `RadioIDList.CSV` (Studio MVP omits — [#302](https://github.com/pskillen/codeplug-studio/issues/302)) |
| 2     | `DMRZone.CSV`                                                                                         |
| 3     | `ScanList.CSV`                                                                                        |
