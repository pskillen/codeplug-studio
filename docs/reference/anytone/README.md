...
| `AMZone.CSV`                            | [am-air.md](am-air.md)                 | Maps to build layout | Planned         | Deferred        | Wire schema confirmed (body rows); export partition [#316](https://github.com/pskillen/codeplug-studio/issues/316) |
