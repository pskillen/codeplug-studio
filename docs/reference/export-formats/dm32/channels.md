...
| `APRS Report Type`                                     | `Channel.aprs.reportType`             | Trim                           | `Off` / `Digital` from binding                                  | Yes                    | Analog channels may report via digital APRS — [aprs.md](aprs.md)                                                          |
| `Forbid TX`                                            | `forbidTransmit`                      | 0/1                            | 0/1 from behavioural cascade                                    | Yes                    | Receive-only when `1`                                                                                                     |
| `APRS Receive`                                         | `Channel.aprs.receiveEnabled`         | 0/1                            | `0` / `1` from binding                                          | Yes                    | [aprs.md](aprs.md)                                                                                                        |
...
| `Lone Work` … `Emergency ACK`                          | —                                     | Ignored                        | **Constant** `0`                                                | Constant               |                                                                                                                           |
| `Analog APRS PTT Mode`                                 | —                                     | Ignored                        | **Constant** `0`                                                | Constant               | No analog APRS hardware — [aprs.md](aprs.md)                                                                              |
| `Digital APRS PTT Mode`                                | `Channel.aprs.digitalPttMode`         | 0/1                            | `0` / `1` from binding                                          | Yes                    | [aprs.md](aprs.md)                                                                                                        |
...
| `APRS Report Channel`                                  | `Channel.aprs.reportSlotIndex`        | Parse int                      | Digital reporting → slot / `1`; else analog `256` / digital `1` | Yes                    | [aprs.md](aprs.md)                                                                                                        |
...
| Global APRS config | `APRS.md`  | No CPS `APRS.csv` — operator guide only ([aprs.md](aprs.md), [#250](https://github.com/pskillen/codeplug-studio/issues/250)) |
