...
| [i007](i007-rt95-serial-write-bit-packing/README.md) | RT95 serial Write packing (bits then `bbcd` freq)                | [#1234](https://github.com/pskillen/codeplug-studio/issues/1234)                                                                                                                                     | **Code shipped** — hardware re-verify GB3GL +7.6 MHz / PTT                                                           |
