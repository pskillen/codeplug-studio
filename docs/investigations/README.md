...
| ---------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| [i003](i003-directory-lookup-banks/README.md)        | Directory rows vs lookup banks (OpenGD77 1701 / DM-32 / AT-D890)       | [#1211](https://github.com/pskillen/codeplug-studio/issues/1211), [#1220](https://github.com/pskillen/codeplug-studio/issues/1220), [#1249](https://github.com/pskillen/codeplug-studio/issues/1249) | 1701 UDB **ACK’d**; MD-9600 silent-repeater LCD still blank — confirm UDB was programmed (not Digital contacts None) |
...
| [i007](i007-rt95-serial-write-bit-packing/README.md) | RT95 serial Write: duplex / tx_off / tone bits packed LSB vs CHIRP MSB | [#1234](https://github.com/pskillen/codeplug-studio/issues/1234)                                                                                                                                     | **Code shipped** — hardware verify pending before merge                                                              |
