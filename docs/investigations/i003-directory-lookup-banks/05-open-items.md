...
i003 is **live**. OpenGD77 encode shipped; hardware unproven. DM-32 still stop-gap.

## Hardware (blocks SoT / merge of #1211)
...
| I003-H8 | Incoming / group-call display shows directory callsign after User Database Write (small fake directory) |
