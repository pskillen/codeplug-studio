...
i003 is **live**. OpenGD77 1701 User Database **Write ACK’d**; LCD lookup still open. DM-32 directory → `0x0F` is in code ([#1220](https://github.com/pskillen/codeplug-studio/issues/1220)); LCD unproven.
