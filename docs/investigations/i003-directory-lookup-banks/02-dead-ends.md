...
| OpenGD77 `SeparateDigitalIdList` means a second *contact* bank like DM-32 `0x67` | G1–G4 | The second firmware store is the User Database. Directory was stuffed into the *first* bank (pre-#1211). |
