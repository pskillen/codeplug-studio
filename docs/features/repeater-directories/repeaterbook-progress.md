...
| `feat(infra): add origin-gated Pages Function proxies for IRTS and RepeaterBook`   | CF proxy + shared origin gate |
| `feat(integrations): route RepeaterBook client through same-origin proxy`          | Client + Vite dev proxy       |
| `docs: document RepeaterBook and IRTS Pages Function origin gates`                 | Tier-3 + build docs           |
