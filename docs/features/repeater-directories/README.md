...
| `ChannelDirectoryVerifyActions.tsx`     | Channel editor Identity verify (UK, IRTS, RepeaterBook, optional BrandMeister repeater) — sidecar [`ChannelDirectoryVerifyActions.md`](../../../src/app/components/repeaters/ChannelDirectoryVerifyActions.md) |
