...
| Wire preview + overrides     | Shipped  | [#87](https://github.com/pskillen/codeplug-studio/issues/87) — sub-routes + `WirePreviewTable`; skip-from-export toggle ([#185](https://github.com/pskillen/codeplug-studio/issues/185)); force-export for library omit zones ([#186](https://github.com/pskillen/codeplug-studio/issues/186)) |
