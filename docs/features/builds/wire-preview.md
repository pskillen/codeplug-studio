...
| ----------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **List**          | `WirePreviewDataTable` on entity routes | Browse, search; inline **Skip** / **Force export**; **`reorderMode`** + order column when reorder config present; **`bulkReorder`** (multi-select, drag, Move toolbar) on flat-memory Channels and build Zones ([#590](https://github.com/pskillen/codeplug-studio/issues/590)); row click opens modal |
