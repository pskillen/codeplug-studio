...
- [x] UI redo: radio-target create, radio-first list, retain nav, sticky default egress (was incomplete after first UI pass).
...
- [x] [#668](https://github.com/pskillen/codeplug-studio/issues/668) — NeonPlug settings / Radio image when hydration bag exists (not only while pathway active).
