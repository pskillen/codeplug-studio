...
- [ ] [#658](https://github.com/pskillen/codeplug-studio/issues/658) — Gate Export projection UI by `radioTargetId` traits (not active egress `profileId`); settings visibility must not change when switching pathways.
