...
| Membership family not wired into live editors      | Medium   | `MembershipRow`/`MembershipPanel`/`MembershipPoolRow`/`AddMembersScreen` (#938) are styleguide-only; zone/RGL/scan editors still use `ShuttleList*`. Channel editor uses light zone chips only ([#941](https://github.com/pskillen/codeplug-studio/issues/941)). Full shuttle migration is [#942](https://github.com/pskillen/codeplug-studio/issues/942)–[#943](https://github.com/pskillen/codeplug-studio/issues/943) |
