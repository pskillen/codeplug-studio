...
| DataTable v2                       | Shipped (#938)               | Full mk2 capability fork — **library list routes migrated** ([#940](https://github.com/pskillen/codeplug-studio/issues/940)); v1 `ui/DataTable` remains for unmigrated surfaces until #927         |
