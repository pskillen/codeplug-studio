...
| 2D ground-track map                | Shipped | [#867](https://github.com/pskillen/codeplug-studio/issues/867) — configurable draw-ahead/behind window [#998](https://github.com/pskillen/codeplug-studio/issues/998); default next-pass-per-satellite tracks when no row is selected ([#1017](https://github.com/pskillen/codeplug-studio/issues/1017)); both viewports render as separate panels, no toggle — [#1009](https://github.com/pskillen/codeplug-studio/issues/1009) |
