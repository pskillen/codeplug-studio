...
| 2026-07-24 | DM-32UV #685    | **Contact-bank Read:** fold V-frame `0x0F` by **header count** (+ V-frame `0x10` / firmware max), never walk start→end 4KB blocks. L01 end near `0xFFF000` previously triggered “Reading block *n* of 3464”.                                                                                                                                                                                                                                          |
