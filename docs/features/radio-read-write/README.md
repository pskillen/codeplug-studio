...
| WebSerial transport + protocol kit           | Shipped     | [#615](https://github.com/pskillen/codeplug-studio/issues/615), [#616](https://github.com/pskillen/codeplug-studio/issues/616) — `src/integrations/radio-io/transport/` + `kit/` (PROGRAM+R/W codec; no radio adapters yet)                                                  |
