...
**Residual gap:** library `txContactRef` → radio-native contact-table index encode remains deferred under [#636](https://github.com/pskillen/codeplug-studio/issues/636); expanded write rows carry correct wire names / timeslots / modes but may leave TX-contact indices unset for RMW.
