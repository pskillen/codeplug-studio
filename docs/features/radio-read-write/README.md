...
| First radio path (UV-5R Mini)                 | Shipped    | [#617](https://github.com/pskillen/codeplug-studio/issues/617) adapter + [#618](https://github.com/pskillen/codeplug-studio/issues/618) — **Direct radio** FormatBuild (`radio-io` / `radio-io-uv5r-mini`); Read hydrates `radio-clone`; Write via `assemble`; no CPS file export                     |
