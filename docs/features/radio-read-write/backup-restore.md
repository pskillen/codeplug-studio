...
| Restore to radio                              | Shipped (D890, OpenGD77) | [#1141](https://github.com/pskillen/codeplug-studio/issues/1141) AT-D890UV; [#1142](https://github.com/pskillen/codeplug-studio/issues/1142) OpenGD77 DM-1701 / MD-9600 `restoreFromBackup` (**hardware verify pending**). Other radios stay inspect-only until their restore PR. Serial mismatch is a hard refuse. |
| Per-radio restorable vs inspect-only maps     | Partial                  | AT-D890UV: [at-d890uv/backup-restore.md](../../reference/radios/anytone/at-d890uv/backup-restore.md). OpenGD77: [opengd77/backup-restore.md](../../reference/radios/opengd77/backup-restore.md). Other families still follow this contract until their restore PR.                                                  |
