...
| RT95                        | Small programming clone. No serial in layout.                                                                                    | Clone `upload` of zip bytes (no live pre-write read inside `upload()`). Write-codeplug overlays in-session (`hydrationRequiredForWrite: false`).                                                                                                                                    |
