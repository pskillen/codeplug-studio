...
| [#1184](https://github.com/pskillen/codeplug-studio/issues/1184) | app          | Shipped     | Shell display controls — exaggeration 1×–10× (default 5× on), exploded stacking (0.15 globe-radii/layer, on), Fresnel limb shading (on). Display panel on `/reference/rf-propagation`                             |
