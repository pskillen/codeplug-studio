...
- **Core domain scaffold** — `src/core/domain/hfPropagation/types.ts` holds `AntennaPatternFamily`, `AntennaConfig`, and `SolarActivityPreset` as of this phase; later tickets (#1165, #1166, #1168) add `IonosphericLayerState`, `RayTraceParams`, `RayPathResult`, and `PropagationMode` alongside these, not replacing them.
