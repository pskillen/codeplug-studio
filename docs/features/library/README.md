...
| Channels list bulk edit                   | In progress ([#1269](https://github.com/pskillen/codeplug-studio/issues/1269))                                                             | **Bulk edit** modal — No change opt-in, editor-matched groups; scan, TX, power, analog tones/squelch, APRS (zones follow in the same ticket)                                    |
