...
| Channel behavioural defaults              | Shipped ([#388](https://github.com/pskillen/codeplug-studio/issues/388))                                                                 | `/library/channels/defaults`; Behaviour tab; schema v18 — see [channel-behavioural-defaults reference](../../reference/channel-behavioural-defaults.md) |
