...
| Uplink / downlink metadata            | Shipped     | [#854](https://github.com/pskillen/codeplug-studio/issues/854) — model + Satellite Keps editor; radio write-packing still not started |
