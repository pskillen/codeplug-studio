...
| Uplink / downlink metadata            | Shipped     | [#854](https://github.com/pskillen/codeplug-studio/issues/854) — model + Satellite Keps editor; [#1020](https://github.com/pskillen/codeplug-studio/issues/1020) added a "populate from SatNOGS transmitter" picker + range validation; radio write-packing still not started |
