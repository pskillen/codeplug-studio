...
- `AMZone.CSV` — two redacted body rows in fixture; wire schema documented ([#316](https://github.com/pskillen/codeplug-studio/issues/316)). Export partition still deferred.
