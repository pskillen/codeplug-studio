...
| Zone-derived `Scan.csv`         | Shipped | [#129](https://github.com/pskillen/codeplug-studio/issues/129) — [zone-derived scan reference](../../../reference/zone-derived-scan-lists.md); empty floor [#564](https://github.com/pskillen/codeplug-studio/issues/564) |
