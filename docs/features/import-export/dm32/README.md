...
| Prefer-NeonPlug export warning  | Shipped | [#556](https://github.com/pskillen/codeplug-studio/issues/556) / [#638](https://github.com/pskillen/codeplug-studio/issues/638) — orange alert on Export when the **dm32 CPS** egress is active (steers to Web Serial or NeonPlug); not on New Radio; CSV download remains available |
