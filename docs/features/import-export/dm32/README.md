...
| Prefer-NeonPlug export warning  | Shipped | [#556](https://github.com/pskillen/codeplug-studio/issues/556) — orange alert on DM32 export UI; CSV download remains available                                                                                               |
