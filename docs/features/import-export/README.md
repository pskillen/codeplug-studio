...
| NeonPlug `.neonplug`                                    | Planned | Epic [#536](https://github.com/pskillen/codeplug-studio/issues/536) — scaffold [#538](https://github.com/pskillen/codeplug-studio/issues/538); wire reference [#537](https://github.com/pskillen/codeplug-studio/issues/537); [neonplug/README.md](neonplug/README.md) |
...
| [neonplug/README.md](neonplug/README.md)                                       | NeonPlug product hub (scaffold shipped; adapters planned)                                                                                                                                                          |
