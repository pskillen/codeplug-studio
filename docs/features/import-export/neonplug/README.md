...
| Area                                                      | Status  | Notes                                                                                                                                                                                                                                                                                                                                        |
| --------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Wire reference                                            | Shipped | [reference/export-formats/neonplug/](../../../reference/export-formats/neonplug/README.md) — [#537](https://github.com/pskillen/codeplug-studio/issues/537)                                                                                                                                                                                  |
...
| Zone-derived scan carrier `scanListId`                    | Shipped | [#1225](https://github.com/pskillen/codeplug-studio/issues/1225) — carriers only; members `0` while still listed in `scanLists[].channels`                                                                                                                                                                                                   |
...
| Merge into radio-read base                                | Shipped | [#551](https://github.com/pskillen/codeplug-studio/issues/551) — retain settings / `radioIds`; see [merge.md](../../../reference/export-formats/neonplug/merge.md)                                                                                                                                                                           |
...
| DM-32UV APRS globals (slots 1–8 + settings) on merge      | Shipped | [#559](https://github.com/pskillen/codeplug-studio/issues/559) — patches donor `radioSettings`; see [aprs.md](../../../reference/export-formats/neonplug/aprs.md)                                                                                                                                                                            |
...
- [NeonPlug wire reference](../../../reference/export-formats/neonplug/README.md)
- [Merge policy](../../../reference/export-formats/neonplug/merge.md)
