...
| UV5R donor persist / settings view                        | Shipped | [#554](https://github.com/pskillen/codeplug-studio/issues/554) — same `cpsWireHydration` + NeonPlug settings nav as DM32UV; UV5R view emphasises `radioInfo` / `radioSettings`                                                                                                                                                               |
