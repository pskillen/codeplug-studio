...
Product behaviour for NeonPlug `.neonplug` files in Codeplug Studio. Wire tables live in the tier-3 [NeonPlug reference](../../../reference/formats/neonplug/README.md).
...
| Area                                                      | Status  | Notes                                                                                                                                                                                                                                                                                                                                        |
| --------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Wire reference                                            | Shipped | [reference/formats/neonplug/](../../../reference/formats/neonplug/README.md) — [#537](https://github.com/pskillen/codeplug-studio/issues/537)                                                                                                                                                                                                |
...
| Merge into radio-read base                                | Shipped | [#551](https://github.com/pskillen/codeplug-studio/issues/551) — retain settings / `radioIds`; see [merge.md](../../../reference/formats/neonplug/merge.md)                                                                                                                                                                                  |
...
| DM-32UV APRS globals (slots 1–8 + settings) on merge      | Shipped | [#559](https://github.com/pskillen/codeplug-studio/issues/559) — patches donor `radioSettings`; see [aprs.md](../../../reference/formats/neonplug/aprs.md)                                                                                                                                                                                   |
...
- [NeonPlug wire reference](../../../reference/formats/neonplug/README.md)
- [Merge policy](../../../reference/formats/neonplug/merge.md)
