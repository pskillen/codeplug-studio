...
| 5   | **Site / repeater wire names**               | Same composer regardless of pathway (where distinct from channel names)                                                                                                                                                | `formats/anytone/channelExpansion.ts` (`resolveAnytoneSiteWireName`) · `app/services/radioIoChannelMap.ts` |
