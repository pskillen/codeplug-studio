...
Tier-1 summary of how `assemble(build, library)` projection maps to OpenGD77 CPS CSV files. Wire column detail lives in [docs/reference/export-formats/opengd77/](../../../reference/export-formats/opengd77/README.md).
