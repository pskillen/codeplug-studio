...
| Play Store AAB / listing            | End goal | CI (AAB build + Closed Testing / Production publish) shipped — see [play-store-publish.md](play-store-publish.md). Still blocked on Play Console app creation, Data safety form, and service-account setup. [#890](https://github.com/pskillen/codeplug-studio/issues/890) |
