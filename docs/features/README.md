...
| Import / export      | `src/core/import-export/`                                             | [import-export/](import-export/) ([progress](import-export/native-yaml-progress.md)) | Phase 3 ([#56](https://github.com/pskillen/codeplug-studio/issues/56)–[#58](https://github.com/pskillen/codeplug-studio/issues/58)) — native YAML core shipped |
