...
Tier-3 column inventories: [Anytone aprs.md](../../reference/export-formats/anytone/aprs.md), [aprs-on-channels.md](../../reference/export-formats/anytone/aprs-on-channels.md), [DM32 channels.md](../../reference/export-formats/dm32/channels.md), [NeonPlug aprs.md](../../reference/export-formats/neonplug/aprs.md).
...
| **NeonPlug DM-32UV**  | `radioSettings` APRS fields (slots 1–8 + scheduled send, beacon, call/upload) | `aprsReceive`, `aprsReportMode` on `channels[]`                                                        | Same library model; merge-export patches donor settings ([#559](https://github.com/pskillen/codeplug-studio/issues/559)) — wire: [neonplug/aprs.md](../../reference/export-formats/neonplug/aprs.md) |
...
| `manualTxIntervalSec` / `autoTxIntervalSec`                 | Seconds in library. Manual exports as plain wire seconds. **Anytone auto** exports as wire byte `k` (`encode`: `k = trunc(s/15) − 3`; `decode`: `s = (k+3)×15`; e.g. wire `9` = 180 s) — [timing wire](../../reference/export-formats/anytone/aprs.md#timing-wire-export-v1) ([#366](https://github.com/pskillen/codeplug-studio/issues/366)) |
