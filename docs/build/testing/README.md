...
Every pull request and push to `main` runs [`.github/workflows/pull-request.yaml`](../../.github/workflows/pull-request.yaml). Vitest emits `test-results/junit.xml` in CI; [dorny/test-reporter](https://github.com/dorny/test-reporter) publishes per-test pass/fail on the PR Checks tab.
...
| CPS wire verify    | `npm run test:cps-verify` | Yes                | Separate Dorny report **CPS wire verify** ([#480](https://github.com/pskillen/codeplug-studio/issues/480)) |
...
| PR checks            | [`../../../.github/workflows/pull-request.yaml`](../../.github/workflows/pull-request.yaml)  |
