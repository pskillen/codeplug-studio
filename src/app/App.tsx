...
import RfPropagationRedirectPage from './routes/reference/RfPropagationRedirectPage.tsx';
...
import BuildRadioBackupPage from './routes/builds/BuildRadioBackupPage.tsx';
...
export const appRouter = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/reference/rf-propagation', element: <RfPropagationRedirectPage /> },
      {
        path: '/styleguide',
            ...
            children: [
              ...
              { path: 'new', element: <NewBuildPage /> },
              {
                ...
                children: [
                  ...
                  { path: 'radio-image', element: <Navigate to="backup" replace /> },
                ],
              },
            ],
          },
