...
export default function AprsConfigurationEditor({
  ...
  return (
    <Stack gap="md" maw={900}>
      ...
      <FieldCard
        title="Beacon timing"
        description="Manual interval is plain seconds on export. Auto interval is stored as entered; Anytone CPS export clamps to the wire range (60–3870 s, 15 s steps)."
      >
        <SimpleGrid cols={{ base: 1, sm: 2 }}>
          ...
          <NumberInput
            ...
            description="Leave empty for off. Values outside Anytone wire range are clamped on Anytone export only."
