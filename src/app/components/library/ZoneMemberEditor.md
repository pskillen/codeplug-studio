...
- **In this zone:** rich channel rows (freq, mode pills, scan skip badge, tri-state zone-derived scan membership), nested zone rows with effective counts, move up/down, Alt+↑/↓, remove per-row or bulk.
