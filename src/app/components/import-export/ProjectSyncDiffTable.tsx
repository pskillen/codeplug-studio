  ...
  return (
    <Stack gap="xs">
      <Text size="sm" c="dimmed">
        <strong>Last edited</strong> is when channels, zones, or other items changed in this copy.{' '}
        <strong>Last Drive or file save</strong> is when this copy was last opened from or written
        to Google Drive or a YAML file.
      </Text>
