...
- **Auto-fit:** the map view fits one world repeat on first load and does not re-center when live position/footprint updates. Orbit-trail polylines are drawn but excluded from any subsequent auto-fit (there is none after mount).
