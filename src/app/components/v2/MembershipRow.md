...
The in-list member row for `MembershipPanel` — mk2 members-first list + full-screen add takeover pattern. Designed as a self-contained card-style row rather than a render prop into an existing list shell.
