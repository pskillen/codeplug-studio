...
describe('UV-5R Mini descriptor / registry', () => {
  it('registers Mini with NeonPlug and CHIRP compatible profiles', () => {
    ...
    expect(listDescriptorsForProfile('neonplug', 'neonplug-uv5rmini')).toHaveLength(1);
    expect(listDescriptorsForProfile('chirp', 'chirp-uv5r')).toHaveLength(1);
