...
import { sampleGroundTrack, sampleOrbitTrack } from './groundTrack.ts';
...
describe('sampleOrbitTrack', () => {
  it('includes positive altitude for LEO samples', () => {
    const samples = sampleOrbitTrack(
      ISS_LINE_1,
      ISS_LINE_2,
      '2024-02-14T18:00:00.000Z',
      '2024-02-14T18:02:00.000Z',
    ...
    for (const sample of samples) {
      expect(sample.altitudeKm).toBeGreaterThan(200);
      expect(sample.altitudeKm).toBeLessThan(500);
    }
  });
});
